...
optimizer_config = optimizer_config[chosen_optimizer]
...
train_loader, val_loader, test_loader = get_dataloaders(
    tokenizer, batch_size=batch_size, max_len=tokenizer_max_len, seed=seed
)
logging.info("AG News dataset loaded successfully.")

# Load model.
logging.info("Loading bert-base-uncased model")
model = load_model(num_labels=4, device="cpu")
